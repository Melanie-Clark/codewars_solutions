"""
ou're on your way to the market when you hear beautiful music coming from a nearby street performer.
...
def is_loch_ness_monster(string):
    return any(word in string for word in ("3.50", "three fifty", "tree fiddy"))